	PROGRAM XdmfCreate
        ...
        ! Paraview and Visit
        ! It uses the INPUTFILEa and assumes that the filenames in the program
        ! are
        ...
        ! Nt = the final Time
        ! plotgap = the number of times before plotting
        ...
        REAL(KIND=8)    :: Lx, Ly, Lz, DT,Nt,plotgap
        ! .. Local scalars ..
